var picker = {
    ...
    attach: function(opt) {
        ...
        var today = new Date(),
            ...
            months = ["January", "Febury", "March", "April", "May", "June",
        ...
        let eventDate = document.querySelector('.two');
        ...
        // (A4) YEAR SELECT
        var yRange = 5; // Year range to show, I.E. from thisYear-yRange to thisYear+yRange
        ...
        // (A6-P) POPUP DATE PICKER
            ...
            while (document.getElementById("picker-" + uniqueID) != null) {
                uniqueID = Math.floor(Math.random() * (100 - 02)) + 1;
            }
            dp.dataset.popup = "1";
    ...
    draw: function(el) {
        ...
        if (parent.dataset.startmon == "1") { daynames.push("Sun"); } else { daynames.unshift("Sun"); }
